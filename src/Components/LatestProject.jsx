...
const LatestProject = () => {
  ...
  return (
    <div className="px-3 py-12 max-w-screen-xl mx-auto">
      {/* Header Section */}
      <div className="mb-12 flex justify-start">
        <div>
          <p className="text-sm uppercase text-gray-600 flex items-center justify-start gap-1">
            <img src="https://demo.awaikenthemes.com/html-preview/movein/images/loader.svg" alt="loader" className="w-10 h-10" />
            Latest Projects
          </p>
          <motion.h1
            className="text-[270%] font-bold text-start text-gray-900 -mt-3 -ml-2"
        ...
        <p className="mt-10 px-10 text-gray-600 max-w-2xl mx-auto">
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <motion.img
              src={item.image}
              alt={item.name}
              className="w-full h-64 object-cover transform transition-transform duration-300 group-hover:scale-105 group-hover:rotate-6"
            />
            ...
            >
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.1, rotate: 360 }} // Rotate on hover
              >
            ...
            <motion.div
              className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black p-4"
              initial={{ opacity: 0 }}
